...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(UnsupportedMathOperationException.class) //ExceptionHandler é um filter que, neste caso, está configurado para interceptar todas as exceções do tipo UnsupportedMathOperationException
